        ...
        <div className="container mt-5 pt-5">
            <div className="card shadow p-4">
                ...
                <div className="mb-4">
                    ...
                    <div>
                        <div className="form-check form-check-inline">
                            ...
                            <label className="form-check-label" htmlFor="anonYes">Yes</label>
                        </div>

                        <div className="form-check form-check-inline">
                            <input className="form-check-input" type="radio" name="anon" id="No" />
                            <label className="form-check-label" htmlFor="anonNo">No</label>
                        </div>
                    </div>
                </div>
                ...
                <div className="d-flex justify-content-between mt-4">
                    ...
                    <Link className="btn btn-warning px-4" to="/"> Continue →</Link>
                </div>

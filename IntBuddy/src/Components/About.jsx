      ...
      <div className="container">
        ...
        <div className="row justify-content-center mb-5">
          <div className="col-md-8 text-center">
            ...
            <p className="lead">This platform helps students and job seekers share real interview experiences to guide and support others in their career journey.</p>
          </div>
        </div>
        ...
        <div className="row text-center">
          ...
          <div className="col-md-4 mb-4">
            <div className="p-4 shadow rounded bg-white h-100">
              ...
              <p>Users can post their interview experiences from different companies to help others prepare better.</p>
            </div>
          </div>
          ...
          <div className="col-md-4 mb-4">
            <div className="p-4 shadow rounded bg-white h-100">
              ...
              <p>Explore real questions, interview patterns, and tips shared by candidates who already appeared.</p>
            </div>
          </div>
          ...
          <div className="col-md-4 mb-4">
            <div className="p-4 shadow rounded bg-white h-100">
              ...
              <p>Support other students by sharing your journey and helping them succeed in interviews.</p>
            </div>
          </div>
